         ...
         <div class="card">
									<div class="card-header">
										...
										<div class="card-options ">
											 <button type="button" data-target="#newModal" data-toggle="modal" class="btn btn-success btn-sm"><i class="fa fa-fw fa-plus"></i>Add New</button>
										</div>
									</div>
									<div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group has_append">
                            ...
                            <div class="input-group-append">
                                <button class="btn btn-outline-secondary iconPicker" data-icon="fa fa-home" role="iconpicker"></button>
                            </div>
                        </div>
