                ...
                <div class="card-body">
                    <div class="form-row">
                        ...
                        <label class="custom-switch">
                         <input type="checkbox" data-height="46px" data-width="100%" data-onstyle="success" data-offstyle="danger" data-toggle="toggle" data-on="Send Email"  class="custom-switch-input" data-off="Don't Send" name="email_status" @if($email_template->email_status) checked @endif>
