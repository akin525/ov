									...
									<div class="row">
										<div class="col-xl-8 col-lg-12 col-md-12">
											<div class="d-sm-flex">
												...
												<div class="ml-4">
													<h4 class="text-uppercase mb-0 mt-1">Active Vault: {{$general->cur_sym}}{{formatter_money(App\Invest::where('user_id', Auth::id())->whereStatus(1)->sum('amount'))}}</h4>
													<h4 class="text-uppercase mb-0 mt-1">Total Vault: {{$general->cur_sym}}{{formatter_money(App\Invest::where('user_id', Auth::id())->whereStatus(0)->sum('amount'))}}</h4>
													<p class="mt-2 mb-0">The return of every on every of the fund you keep in out vault is credited into your Interest wallet once mature.</p>
